...
class GameWindow < Gosu::Window #https://www.rubydoc.info/github/gosu/gosu/Gosu/Window
    ...
    def update
            ...
            @bird_vel.y += GRAVITY.y * (update_interval / 1000)
    ...
    def bird_rect #dibuixar el rectangle de l'ocell
        bird_rect = Rect.new(
            pos: @bird_pos, 
    ...
    def obstacle_rect #dibuixar el rectangle dels obstacles
         @obstacles.flat_map do |obstacle| #flat_map agafa l'array d'obstacles i la retornem en una array de [top, bottom, base] que a la vegada son arrays
            top = Rect.new(
    ...
    def bird_coll? # retorna true si hi ha colisio
        bird_r=bird_rect
    ...
    def rectangle_intersect?(br, obsr)#quan hi ha intersecció entre el rectangle de l'ocell(br) i els rectgangles de l'obstacle(obsr)
